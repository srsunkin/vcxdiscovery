...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DZlh9ZzE.mjs");
...
var manifest = { "68dd462549e8c2e4da03ad33191368701999b91fb87b5dde3567a1f558028f87": {
	functionName: "assistDeal_createServerFn_handler",
	importer: () => import("./ai-D8EPjsOg.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-fudB7XKc.mjs").then((n) => n.t),
