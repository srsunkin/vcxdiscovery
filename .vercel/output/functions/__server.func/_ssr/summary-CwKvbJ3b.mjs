import { d as on, f as useDealStore, l as computeProgress, p as v } from "./router-fudB7XKc.mjs";
import { n as topRoute } from "./routing-BtOsCza6.mjs";
import { t as computeRisks } from "./risk-BhFCEv8N.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/summary-CwKvbJ3b.js
function dash(s) {
...
function buildSummary() {
	...
	return [
		...
		`Risks: ${risks.items.filter((i) => i.level !== "ok").slice(0, 6).map((i) => i.text).join("; ") || "No major risks detected"}`,
...
Risks / mitigation:
${computeRisks().items.map((i) => `- ${i.text}`).join("\n")}
...
//#endregion
export { buildSummary as n, snapshotSignals as r, buildHandoff as t };
